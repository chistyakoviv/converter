...
CREATE INDEX IF NOT EXISTS conversion_queue_status_media_type_idx ON conversion_queue (status, media_type);
-- +goose StatementEnd
...
DROP INDEX IF EXISTS conversion_queue_status_media_type_idx;
