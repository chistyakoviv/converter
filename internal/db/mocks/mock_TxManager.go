...
import (
	...
	db "github.com/chistyakoviv/converter/internal/db"
...
func (_m *MockTxManager) ReadCommitted(ctx context.Context, f db.TxHandler) error {
	ret := _m.Called(ctx, f)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, db.TxHandler) error); ok {
		r0 = rf(ctx, f)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockTxManager_ReadCommitted_Call) Run(run func(ctx context.Context, f db.TxHandler)) *MockTxManager_ReadCommitted_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(db.TxHandler))
	})
	return _c
}
...
func (_c *MockTxManager_ReadCommitted_Call) RunAndReturn(run func(context.Context, db.TxHandler) error) *MockTxManager_ReadCommitted_Call {
	_c.Call.Return(run)
	return _c
}
