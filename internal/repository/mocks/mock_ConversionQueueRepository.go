...
// FindOldestQueuedImages provides a mock function with given fields: ctx
func (_m *MockConversionQueueRepository) FindOldestQueuedImages(ctx context.Context) (*model.Conversion, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for FindOldestQueuedImages")
	}
...
// MockConversionQueueRepository_FindOldestQueuedImages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOldestQueuedImages'
type MockConversionQueueRepository_FindOldestQueuedImages_Call struct {
	*mock.Call
}

// FindOldestQueuedImages is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockConversionQueueRepository_Expecter) FindOldestQueuedImages(ctx interface{}) *MockConversionQueueRepository_FindOldestQueuedImages_Call {
	return &MockConversionQueueRepository_FindOldestQueuedImages_Call{Call: _e.mock.On("FindOldestQueuedImages", ctx)}
}

func (_c *MockConversionQueueRepository_FindOldestQueuedImages_Call) Run(run func(ctx context.Context)) *MockConversionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConversionQueueRepository_FindOldestQueuedImages_Call) Return(_a0 *model.Conversion, _a1 error) *MockConversionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConversionQueueRepository_FindOldestQueuedImages_Call) RunAndReturn(run func(context.Context) (*model.Conversion, error)) *MockConversionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Return(run)
	return _c
}

// FindOldestQueuedVideos provides a mock function with given fields: ctx
func (_m *MockConversionQueueRepository) FindOldestQueuedVideos(ctx context.Context) (*model.Conversion, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for FindOldestQueuedVideos")
	}
...
// MockConversionQueueRepository_FindOldestQueuedVideos_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOldestQueuedVideos'
type MockConversionQueueRepository_FindOldestQueuedVideos_Call struct {
	*mock.Call
}

// FindOldestQueuedVideos is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockConversionQueueRepository_Expecter) FindOldestQueuedVideos(ctx interface{}) *MockConversionQueueRepository_FindOldestQueuedVideos_Call {
	return &MockConversionQueueRepository_FindOldestQueuedVideos_Call{Call: _e.mock.On("FindOldestQueuedVideos", ctx)}
}

func (_c *MockConversionQueueRepository_FindOldestQueuedVideos_Call) Run(run func(ctx context.Context)) *MockConversionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockConversionQueueRepository_FindOldestQueuedVideos_Call) Return(_a0 *model.Conversion, _a1 error) *MockConversionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConversionQueueRepository_FindOldestQueuedVideos_Call) RunAndReturn(run func(context.Context) (*model.Conversion, error)) *MockConversionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Return(run)
	return _c
}
