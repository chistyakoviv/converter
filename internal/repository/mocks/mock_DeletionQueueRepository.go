...
func (_m *MockDeletionQueueRepository) FindOldestQueuedImages(ctx context.Context) (*model.Deletion, error) {
	ret := _m.Called(ctx)
...
// MockDeletionQueueRepository_FindOldestQueuedImages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOldestQueuedImages'
type MockDeletionQueueRepository_FindOldestQueuedImages_Call struct {
	*mock.Call
}

// FindOldestQueuedImages is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockDeletionQueueRepository_Expecter) FindOldestQueuedImages(ctx interface{}) *MockDeletionQueueRepository_FindOldestQueuedImages_Call {
	return &MockDeletionQueueRepository_FindOldestQueuedImages_Call{Call: _e.mock.On("FindOldestQueuedImages", ctx)}
}

func (_c *MockDeletionQueueRepository_FindOldestQueuedImages_Call) Run(run func(ctx context.Context)) *MockDeletionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockDeletionQueueRepository_FindOldestQueuedImages_Call) Return(_a0 *model.Deletion, _a1 error) *MockDeletionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeletionQueueRepository_FindOldestQueuedImages_Call) RunAndReturn(run func(context.Context) (*model.Deletion, error)) *MockDeletionQueueRepository_FindOldestQueuedImages_Call {
	_c.Call.Return(run)
	return _c
}

// FindOldestQueuedVideos provides a mock function with given fields: ctx
func (_m *MockDeletionQueueRepository) FindOldestQueuedVideos(ctx context.Context) (*model.Deletion, error) {
	ret := _m.Called(ctx)
...
// MockDeletionQueueRepository_FindOldestQueuedVideos_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindOldestQueuedVideos'
type MockDeletionQueueRepository_FindOldestQueuedVideos_Call struct {
	*mock.Call
}

// FindOldestQueuedVideos is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockDeletionQueueRepository_Expecter) FindOldestQueuedVideos(ctx interface{}) *MockDeletionQueueRepository_FindOldestQueuedVideos_Call {
	return &MockDeletionQueueRepository_FindOldestQueuedVideos_Call{Call: _e.mock.On("FindOldestQueuedVideos", ctx)}
}

func (_c *MockDeletionQueueRepository_FindOldestQueuedVideos_Call) Run(run func(ctx context.Context)) *MockDeletionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockDeletionQueueRepository_FindOldestQueuedVideos_Call) Return(_a0 *model.Deletion, _a1 error) *MockDeletionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDeletionQueueRepository_FindOldestQueuedVideos_Call) RunAndReturn(run func(context.Context) (*model.Deletion, error)) *MockDeletionQueueRepository_FindOldestQueuedVideos_Call {
	_c.Call.Return(run)
	return _c
}
