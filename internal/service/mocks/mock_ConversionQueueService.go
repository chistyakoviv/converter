...
func (_m *MockConversionQueueService) PopImages(ctx context.Context) (*model.Conversion, error) {
	ret := _m.Called(ctx)
...
// MockConversionQueueService_PopImages_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PopImages'
type MockConversionQueueService_PopImages_Call struct {
	*mock.Call
}

// PopImages is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockConversionQueueService_Expecter) PopImages(ctx interface{}) *MockConversionQueueService_PopImages_Call {
	return &MockConversionQueueService_PopImages_Call{Call: _e.mock.On("PopImages", ctx)}
}

func (_c *MockConversionQueueService_PopImages_Call) Run(run func(ctx context.Context)) *MockConversionQueueService_PopImages_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockConversionQueueService_PopImages_Call) Return(_a0 *model.Conversion, _a1 error) *MockConversionQueueService_PopImages_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConversionQueueService_PopImages_Call) RunAndReturn(run func(context.Context) (*model.Conversion, error)) *MockConversionQueueService_PopImages_Call {
	_c.Call.Return(run)
	return _c
}

// PopVideos provides a mock function with given fields: ctx
func (_m *MockConversionQueueService) PopVideos(ctx context.Context) (*model.Conversion, error) {
	ret := _m.Called(ctx)
...
// MockConversionQueueService_PopVideos_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PopVideos'
type MockConversionQueueService_PopVideos_Call struct {
	*mock.Call
}

// PopVideos is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockConversionQueueService_Expecter) PopVideos(ctx interface{}) *MockConversionQueueService_PopVideos_Call {
	return &MockConversionQueueService_PopVideos_Call{Call: _e.mock.On("PopVideos", ctx)}
}

func (_c *MockConversionQueueService_PopVideos_Call) Run(run func(ctx context.Context)) *MockConversionQueueService_PopVideos_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *MockConversionQueueService_PopVideos_Call) Return(_a0 *model.Conversion, _a1 error) *MockConversionQueueService_PopVideos_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConversionQueueService_PopVideos_Call) RunAndReturn(run func(context.Context) (*model.Conversion, error)) *MockConversionQueueService_PopVideos_Call {
	_c.Call.Return(run)
	return _c
}
